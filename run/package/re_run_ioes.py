...
def get_failed_ioe_with_no_sym_ri(cache_config, bench, ioe_path, sym_ri_path):
    failed_ioes = {}
    for mode in ["src_only", "src_snk", "src_snk_plus", "ibound"]:
...
def verfiy(bench):
    ...
    failed_ioes = get_failed_ioe_with_no_sym_ri("cls32_ds8", bench, ioe_path, sym_ri_path)
