...
for cache_config in ['cls32_ds8']:
    ...
    for bench, n_paras in bench_n_paras.items():
        ...
        for verify_size in [32]:
            ...
            cmd = "../input-output_example_gen/bin/bench_bin/stencil_" + cache_config + "_trace " + sizes_str + " > ./data/traced_data/" + cache_config + "/" + bench + "/" + bench + "_" + cache_config + "_" + sizes_str + "_trace.txt"
            os.system(cmd)       
