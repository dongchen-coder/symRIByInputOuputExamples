...
bool bottomUpSearch::isGrowRuleSatisfied(BaseType* i, BaseType* j, BaseType* k, string op, int depthBound) {
    ...
    if (searchMode == "PerSrcIter") {
        ...
        if (op == "PLUS") {
            ...
            if (dynamic_cast<Num*>(i) != 0 && dynamic_cast<Num*>(j) != 0) {
